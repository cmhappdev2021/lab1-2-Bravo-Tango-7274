...
print("No, it is a constant and not a variable so I can't change it")
...
print("Yes, it works because I changed a variable which you can change, but I was trying to change a constant previously which I can't change.")
...
*/
var numOfLikes = 77
print("I chose var because the number of likes will change")
var numOfCommets = 30
print("I chose var because the number of comment will change")
let yearCreated = 2015
print("I chose let because it will always have been created that year")
let monthCreated = "August"
print("I chose let because it will always have been created that month")
let dayCreated = 9
print("I chose let because it will always have been created that day")
...
var numStepsToday = 1700
print("I chose var because I can still add steps")
let numStepsGoal = 2500
print("I chose let because the goal for the number of steps will be the same")
var averageHeartRate = 90
print("I chose var because my heart rate could still go up or down")
// Now go back and add a line after each constant or variable declaration. On those lines, print a statement explaining why you chose to declare the piece of information as a constant or variable.

// Type Safety
// Declare two variables, one called firstDecimal and one called secondDecimal. Both should have decimal values. Look at both of their types by holding Option and clicking on the variable name.
var firstDecimal = 1.5
var secondDecimal = 5.1
// Declare a variable called trueOrFalse and give it a boolean value. Try to assign it to firstDecimal like so: firstDecimal = trueOrFalse. Does it compile? Print a statement to the console explaining why not, and remove the line of code that will not compile.
var trueOrFalse = true
print("No because I tried to assign a bool value for a double")
// Declare a variable and give it a string value. Then try to assign it to firstDecimal. Does it compile? Print a statement to the console explaining why not, and remove the line of code that will not compile.
var test = "Hi"
print("No because I am assigning a sting value to a double")
// Finally, declare a variable with a whole number value. Then try to assign it to firstDecimal. Why won't this compile even though both variables are numbers? Print a statement to the console explaining why not, and remove the line of code that will not compile.
var num = 7
print("It did not work because i was trying to assign a whole number to a double")
